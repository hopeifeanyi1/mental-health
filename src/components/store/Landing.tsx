        ...
        <div className='overflow-scroll'>
            <div className='relative'>
                ...
                <div className='relative flex justify-center lg:items-center lg:h-[92dvh] h-[99dvh]'>
                    <div className='md:w-3/4 w-full text-center mt-48 md:mt-72 lg:mt-0'>
                        <p className=' md:text-6xl text-4xl font-semibold'>Your Mental <span className='text-[#5c86a9]'>Health</span> Companion, Anytime, Anywhere.</p>
                        <p className='font-semibold md:text-xl text-lg md:mt-16 mt-9 px-3 md:px-0'>Talk to a supportive chatbot designed to help you through tough moments.</p>
                        <div className='group'>
                            ...
                            <div className='group-hover:bg-[#5c86a9]/80 bg-[#5c86a9] mx-auto h-10 w-60 rounded-[50%] absolute lg:bottom-[49px] md:bottom-[179px] bottom-[149px] lg:right-[42%] right-[10%] lg:left-[42%] left-[10%]' />
                            ...
                            <div className='bg-[#5c86a9] mx-auto h-7 rounded-[50%] absolute lg:bottom-[-7px] md:bottom-[123px] bottom-[93px] lg:right-[47%] right-[15%] left-[15%] lg:left-[47%] w-16'/>
                            <div className='absolute lg:bottom-[-122px] bottom-[-49px] lg:right-[37%] lg:left-[37%] md:right-[25%] md:left-[25%] left-[10%] right-[10%] bg-[#5c86a9] mx-auto h-24 lg:w-[26%] md:w-[50%] w-[80%] mt-7 rounded-[70%]'/>
                        </div>
                    </div>
                </div>
            </div>
