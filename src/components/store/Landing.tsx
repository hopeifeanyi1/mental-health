            ...
            <div className='relative'>
                ...
                <div className='relative flex justify-center lg:items-center lg:h-[92dvh] h-[99dvh]'>
                    <div className='md:w-3/4 w-full text-center mt-48 md:mt-72 lg:mt-0'>
                        <motion.p className=' md:text-6xl text-4xl font-semibold' initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 0.8 }} transition={{ duration: 1 }}>Your <span className='text-[#5c86a9]'>Mental Health</span> Companion, Anytime, Anywhere.</motion.p>
                        <motion.p className='font-semibold md:text-xl text-lg md:mt-16 mt-9 px-3 md:px-0' initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }}>Talk to a supportive chatbot designed to help you through tough moments.</motion.p>
                        <div className='group'>
