    ...
    <div>
        <div className='lg:hidden block'>
            <div className='lg:hidden flex justify-between bg-zinc-200 rounded-full py-[7px] mx-[8px]'>
                ...
                <p onClick={handleSignIn} className='cursor-pointer text-white bg-black py-[9px] rounded-full text-md mr-[7px] flex items-center px-[15px] font-semibold'>Try for Free</p>
            </div>
        </div>
        ...
        <div className='flex my-auto px-[13px] space-x-5 font-semibold'>
            ...
            <p onClick={handleSignIn} className='text-white cursor-pointer bg-black py-[13px] px-4 rounded-full'>Try for Free</p>
        </div>
        </div>
    </div>
  )
